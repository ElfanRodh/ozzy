"use strict";
angular
  .module("common.fabric", ["common.fabric.window", "common.fabric.directive", "common.fabric.canvas", "common.fabric.dirtyStatus"])
    ...
    function (FabricWindow, $timeout, $window, FabricCanvas, FabricDirtyStatus) {
      return function (options) {
        ...
        fabric.Object.prototype.customiseCornerIcons({
          ...
          tl: {
            icon: "assets/plugins/design-tailor/images/icons/rotate.jpg",
          },
          tr: {
            icon: "assets/plugins/design-tailor/images/icons/resize.jpg",
          },
          bl: {
            icon: "assets/plugins/design-tailor/images/icons/delete.png",
          },
          br: {
            icon: "assets/plugins/design-tailor/images/icons/move.jpg",
          },
          mb: {
            icon: "assets/plugins/design-tailor/images/icons/move.jpg",
          },
        ...
        self.drawWordCloud = function (wordsInit) {
          var color = d3.scale.linear().domain([0, 1, 2, 3, 4, 5, 6, 10, 15, 20, 40, 60, 80, 100]).range(["#5254A3", "#8CA252", "#DE9ED6", "#6B6ECF", "#A55194", "#D6616B", "#E7BA52", "#9C9EDE", "#393B79", "#B51E1E", "#045725", "#1759BB", "#78243d", "#008080"]);
          $("#wordcloud").html("");
